...
var cloths_men_women = document.getElementById("cloths_men_women");
var acc_men_women = document.getElementById("acc_men_women");
for (var data = 0; data <= productList.length; data++) {
  var newProduct = productList[data];

  var card = document.createElement("Div");
  card.classList.add("card");

  var img = document.createElement("img");
  img.src = newProduct.preview;
  img.classList.add("image");

  var h4 = document.createElement("H4");
  h4.innerText = newProduct.name;
  h4.classList.add("heading");

  var Para = document.createElement("P");
  Para.innerText = newProduct.brand;
  Para.classList.add("p");

  var span = document.createElement("span");
  span.innerText = "Rs " + newProduct.price;
  ...
  if (newProduct.isAccessory) {
    acc_men_women.append(card);
  } else {
    cloths_men_women.append(card);
  }
}
